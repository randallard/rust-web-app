...
use argon2::{
    password_hash::SaltString, Algorithm, Argon2, PasswordHasher as _,
    Params, PasswordHash, PasswordVerifier, Version,
};
...
mod tests {
    ...
    fn test_scheme_02_hash_into_b64u_ok() -> Result<()> {
        let fx_to_hash = ContentToHash {
            ...
            salt: Uuid::parse_str("c094e012-b121-4d09-90a7-f0392a4984cf")?,
        };
        let fx_res = "$argon2d$v=19$m=19456,t=2,p=1$wJTgErEhTQmQp/A5KkmEzw$ZjK/c13hYd3AReghyjfVbn9TXwmasDiAzIn1+qSyKqw".to_string();
        let scheme = Scheme02;
